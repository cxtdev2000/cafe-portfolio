...
export const handFont = '"Chalkboard SE", "Bradley Hand", "Segoe Print", "Comic Sans MS", cursive';

// Flowing script for the neon sign; falls back to any cursive face.
export const scriptFont = '"Snell Roundhand", "Brush Script MT", "Segoe Script", cursive';
