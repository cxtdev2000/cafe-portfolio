...
export function CafeExperience() {
  ...
  return (
    <main className="h-dvh w-full overflow-hidden bg-espresso">
      <CafeScene view={view} onSelect={setSection} onReady={() => setReady(true)} />
      ...
      {started && section === null && (
        <p className="pointer-events-none fixed inset-x-0 bottom-6 z-10 animate-fade-in text-center text-sm text-cream/70 [animation-delay:2s]">
