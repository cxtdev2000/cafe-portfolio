      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-[#302924] pb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/"
              className="px-4 py-2 text-xs font-medium rounded-xl bg-[#c68b59] hover:bg-[#b57a48] text-white transition shadow-sm active:scale-95 flex items-center gap-1.5"
            >
              Vào quán ☕
            </Link>
          </div>
